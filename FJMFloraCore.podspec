#
#  Be sure to run `pod spec lint FJMFloraCore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  FJMFloraCore have some object-c component and category
                   DESC
  ...
  s.author             = { "" => "478560836@163.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "478560836@163.com" }
  ...
  s.source       = { :git => "https://github.com/FJM-ZX/FloraCore.git", :tag => s.version}
